 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://gpb/", wsdlLocation = "http://10.2.57.153:8080/Hello_WS/WebServiceImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://gpb/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.2.57.153:8080/Hello_WS/WebServiceImplService?wsdl");
    ...
    public WebService1 getWebServiceImplPort() {
        return super.getPort(new QName("http://gpb/", "WebServiceImplPort"), WebService1.class);
    }
     ...
     */
    @WebEndpoint(name = "WebServiceImplPort")
    public WebService1 getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://gpb/", "WebServiceImplPort"), WebService1.class, features);
    }
